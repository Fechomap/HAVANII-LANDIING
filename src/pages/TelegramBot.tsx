...
import { ArrowRight, CheckCircle, MessageCircle, Map, DollarSign, Truck, Clock, Shield, Smartphone, Globe, Play } from 'lucide-react';
...
const HeroSection = () => {
  ...
  const [videoSrc, setVideoSrc] = useState('/videos/telegrambot-demo.mp4');
  ...
  return (
    <section className="relative w-full min-h-[90vh] overflow-hidden flex flex-col pt-32 md:pt-48">
      ...
      <VideoModal
        ...
        videoSrc={videoSrc}
        videoTitle="Telegram Bot: Consulta de Expedientes y Cotizaciones"
      />
    </section>
  );
};
